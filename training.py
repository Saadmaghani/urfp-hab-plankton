            ...
            for i, data in enumerate(trainLoader, 0):
                ...
                if i % 10 == 0:
                    ...
                    if self.autoencoder:
                        ...
                        #idxs = torch.unique(torch.nonzero(train_target==2)[:,0])
                        if "Tr_Targ_time" in other_stats:
                            other_stats["Tr_Targ_time"].append(train_target.tolist())
                            other_stats["Tr_Pred_time"].append(train_pred.tolist())
                        else:
                            other_stats["Tr_Targ_time"] = [train_target.tolist()]
                            other_stats["Tr_Pred_time"] = [train_pred.tolist()]
