...
# version 1.5 = z_dim = 15, h_dim = 256,8,16. 2 classes
# version 1.6 = same as 1.5 except z_dim = 8
# version 1.7 = z_dim = 32, 1 class (detritus)
# version 2.0 = 1 conv layer, z_dim = 32, h_dim = 32,64,128
